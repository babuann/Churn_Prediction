...
class DataProcessor:
    ...
    def preprocessed_data(self,df):
        try:
            logger.info("Satrting Data processing")
            ...
            logger.info("Skweness Handling")
            skew_threshold=self.config["data_processing"]["skweness_threshold"]
    ...
    def feature_selection(self,df):
        try:
            ...
            logger.info(f"features selcetd:{num_features_to_select}")
            top_10_feature_df=top_features_importance_df["feature"].head(num_features_to_select).values
    ...
    def process(self):
        try:
            ...
            logger.error(f"Error during preprocessing pipline {e}")
